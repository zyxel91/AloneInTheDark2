...
public class Fire1 : MonoBehaviour
{
    ...
    void Update()
    {
       if (Input.GetKeyDown(KeyCode.RightShift) && TakeObjects1.pos == Vector2.right && CanFire == true) {
         Instantiate(_fire, _PlaceFire.transform.position, transform.rotation);
         FireCount++;
       }
       if (Input.GetKeyDown(KeyCode.RightShift)&& TakeObjects1.pos == Vector2.left && CanFire == true) {
