...
public class Fire2 : MonoBehaviour
{
    ...
    void Update()
    {
       if (Input.GetKeyDown(KeyCode.Space) && TakeObjects2.pos == Vector2.right && CanFire == true) {
         Instantiate(_fire, _PlaceFire.transform.position, transform.rotation);
         FireCount++;
       }
       if (Input.GetKeyDown(KeyCode.Space)&& TakeObjects2.pos == Vector2.left && CanFire == true) {
