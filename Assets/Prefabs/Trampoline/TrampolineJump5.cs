...
public class TrampolineJump5 : MonoBehaviour
{
   ...
   public GameObject textAct;
     ...
     private void OnCollisionEnter2D(Collision2D collision) {
      if(collision.gameObject.tag == "Player" && ButtonTramp5.Button_5 == 0) {
            textAct.SetActive(true);
        }
        if(collision.gameObject.tag == "Player" && ButtonTramp5.Button_5 == 1) {
            anim.Play("JumpAnim");
